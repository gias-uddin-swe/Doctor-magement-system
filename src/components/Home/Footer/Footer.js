    ...
    return (
        <div className="Footer">
            ...
            <h5 className="footer-title">
                ...
                <span className="m-2 p-3">
                <FontAwesomeIcon icon={faClinicMedical} /> onLine Service</span>
                <span className="m-2 p-3">
                <FontAwesomeIcon icon={faAmbulance} /> onLine Service</span>
                <span className="m-2 p-3">
                <FontAwesomeIcon icon={faHospital} /> onLine Service</span>
                </h5>
            </div>
...
<p><small>
© 2017 - IWTHEMES® ENVATOenvato brand. ALL RIGHTS RESERVED. PRIVACY POLICY
    </small></p>
                </footer>
