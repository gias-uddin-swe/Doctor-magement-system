...
const Doctors = () => {
    ...
    return (
        <div className="container allDoctors">
            ...
            <div className="row">
                {
                   fakeData.map(pd=><div className="col-md-4">
                   <div className="doctor">
                       ...
                       <p><span>
                           <a href={pd.facebook}><FontAwesomeIcon icon={faFacebook} /></a></span>
                       <span>
                           <a href={pd.instagram}><FontAwesomeIcon icon={faInstagram} /></a></span>
                       <span>
                           <a href={pd.youtube}><FontAwesomeIcon icon={faYoutube} /></a></span>
                       </p>
                       </div>
                   </div>
               </div>) 
