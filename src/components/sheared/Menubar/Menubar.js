            ...
            <div className="row menu-container">
                ...
                <div className="col-md-11 col-lg-10 col-sm-12 logo d-flex align-items-center justify-content-center">
                    <ul className="d-flex align-items-center justify-content-center menu-items">
                        ...
                        <Link className="menu-link" to="/appointment"><li>Get Appointment</li></Link>
                        <Link className="menu-link" to="/doctors"><li>Doctors</li></Link>
                        <Link className="menu-link" to="/contact"><li>Contact us</li></Link>
                        <Link className="menu-link" to="/login"> <li>Login</li></Link>
