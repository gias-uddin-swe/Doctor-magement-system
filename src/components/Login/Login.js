    ...
    return (
        <div>
            <div className="row">
                ...
                <button onClick={handleDoctorLogin} className="btn btn-success m-3">Doctor Login</button>
            <button onClick={handleCustomerLogin} className="btn btn-info m-3">Customer Login</button>
            <button onClick={handleAdminLogin} className="btn btn-danger m-3">Admin Login</button>
            </div>
                {condition.doctor?<DoctorLogin></DoctorLogin>:

                condition.customer?<CustomarLogin></CustomarLogin>:<AdminLogin></AdminLogin>}
